...
while True:
    ...
    latestMailPath = browser.find_element_by_xpath("//*[@id='conversation-list-columns']/section/div[1]/div[2]/div[1]/h4/span[3]").text
    ...
    if latestMailPath.lower() == "ddos":
        ...
        if mailTimeX not in ddosAndTime:
            ...
            warningsText.write(f"{mailSenderNameX} sent a DDOS included at {mailTimeX}\n")
            warningsText.close()
